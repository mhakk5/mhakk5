...
### Backend
- **PHP/Symfony** (Symfony , API Platform, DDD patterns)
...
- Debugged and resolved production issues in Symfony 6→7 migration
...
- **n8n automation workflows** for:
  - Expense tracking (Telegram → ChatGPT → Google Sheets)
...
- **Symfony 8 Certification** - Exam preparation 
...
🚀 **Automation** - Building tools that reduce manual work and increase productivity  
📈 **Continuous Learning** - Staying updated with latest tech, certifications, hands-on practice  
...
- **LinkedIn:** [Connect with me](https://linkedin.com/in/mouataz-hakkou)
- **Email:** [hakkoumouataz@gmail.com](mailto:hakkoumouataz@gmail.com)
- **Website:** [--Coming Soon]
...
- Built 50+ n8n automation workflows for business processes
...
Open to collaborations, freelance opportunities, and technical discussions. Feel free to reach out! 🚀
